...
class ConnectionManager {
            ...
            if (this.currentSelectedSocket) {
                ...
                if (connTo != null && this.currentSelectedSocket.isInput !== connTo.isInput && !this.currentSelectedSocket.node.handle.isSameNode(connTo.node.handle)) {
                    ...
                    if (inp.connections.length == 0) {
                        ...
                        this.createConnection(this.currentSelectedSocket, connTo);
    ...
    createConnection(skt1, skt2) {
        skt1.connections.push(skt2);
        skt2.connections.push(skt1);

        skt1.updateConnections();
        skt2.updateConnections();

        const out = skt2.isInput ? skt1 : skt2;
        const inp = skt2.isInput ? skt2 : skt1;
